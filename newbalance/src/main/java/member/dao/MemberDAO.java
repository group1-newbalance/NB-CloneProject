...
public class MemberDAO implements IMember {
	...
	public int insert(Connection conn, MemberDTO mem) throws SQLException {
		...
		PreparedStatement pstmt = null;
		String sql = " insert into user_info(" + "user_code, user_id, user_pwd, " + "user_gender, user_skt, user_phone,"
				+ "user_name, user_birth, user_nativecheck," + "user_tel, user_receiveinfo, user_specialdate"
	...
	public int update(Connection con, MemberDTO mem) throws SQLException {
		...
		String sql = "update user_info " + "set message=?, guest_name = ?" + "where message_id=? and password=?";
		try {
