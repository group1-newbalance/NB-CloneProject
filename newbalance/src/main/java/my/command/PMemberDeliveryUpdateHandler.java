...
public class PMemberDeliveryUpdateHandler implements CommandHandler{
		...
		if (session != null) {
			...
			if (member != null) {
				try {
					...
					System.out.println("ma_phone : " + "["+ maPhone + "]");
					System.out.println("ma_phone length : " + maPhone.length());
					
					MyDeliveryInfoDTO dto = new MyDeliveryInfoDTO(maSeq, member.getUserCode(), maName, maZipcode, maAddress1, maAddress2, maPhone, maDefault);
					
					rowCount = myPageService.updateMemberDeliveryInfo(dto);
