...
<script type="text/javascript">
		...
		$(window.document).ready(function(){
			...
			$("#btnMemberModify").click(function(){
				...
				$("form[name='myForm']").attr("action", "/my/customer/memberModifyProc.action").attr("target", "_self").submit();
			});				
...
<div class="layer_pop w700" id="pwSettingLayer" style="display: none;">
	<div class="pop_inner">
		...
		<div class="contents">
			...
			<div class="form_area change_pw">
				<ul class="sub_info">
					<li>회원님은 카카오 <span>gayul8300</span> 아이디로 가입한 회원입니다.</li>
...
<script type="text/javascript">
	...
	<form method="post" name="myForm" action="memberModifyProc.jsp" data-gtm-form-interact-id="0">
                        ...
                        <fieldset>
                            ...
                            <div class="form_area">
                                ...
                                <div class="row type_low">
                                    ...
                                    <div class="fdata"><span>${ mem.userName }</span></div>
                                </div>
                                <div class="row type_low">
								...
								<div class="row b_line">
                                   <label class="ftit">비밀번호</label>
                                    <div class="fdata">
										...
										<span id="pwChange" class="txt_ok" style="display: none;"></span>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="fdata input_letdown">
                                        ...
                                        <input type="text" id="cellNo02" name="cellNo02" class="ip_text sm" disabled="disabled" title="휴대전화 가운데 번호" value="${ mem.userTel.substring(3,7)}">
                                        <input type="text" id="cellNo03" name="cellNo03" class="ip_text sm" disabled="disabled" title="휴대전화 마지막 번호" value="${ mem.userTel.substring(7,11)}">
                                    ...
                                    <div class="fdata input_letdown" id="cellChangeForm" style="display: none; margin-top: 20px">
                                        ...
                                        <a href="javascript:;" class="btn_ty_form" id="btnAuthNumberRequestAgain" style="display: none;">인증번호 재요청</a> <!-- 인증번호 요청 후 -->
								...
								<div class="row con_num" id="smsCertInputArea" style="display: none;">
		                            ...
		                            <div class="fdata">
		                                <span class="select_box">
		                                    <select id="phoneNum1" name="phoneNum1" title="자택 앞 번호" disabled="disabled">
												...
												<input type="text" id="phoneNum2" name="phoneNum2" value="" class="ip_text sm" title="자택 가운데 번호" maxlength="4" readonly="">
																								
											
												                                
										
											
												<input type="text" id="phoneNum3" name="phoneNum3" value="" class="ip_text sm" title="자택 마지막 번호" maxlength="4" readonly="">
																								
											
													                                
		                                
		                                <span class="chk"><input type="checkbox" id="homeTel" name="homeTel" checked="" class="ip_chekbox"><label for="homeTel">없음</label></span>
            ...
            oncomplete: function(data) {
                ...
                document.getElementById("sample6_detailAddress").focus();
		                        ...
		                        <div class="row">
		                            ...
		                            <div class="fdata">
		                                <input type="text" id="txtOrderEmail1" name="txtOrderEmail1" class="ip_text sm" title="이메일 아이디" maxlength="25" value="yebin3377">
		                                <em class="unit">@</em>
                            ...
                            <div class="form_area">
                                <div class="row type_low">
                                    ...
                                    <div class="fdata">
                                        <span class="chk"><input type="checkbox" id="receiveMail" name="receiveMail" class="ip_chekbox" value="0"><label for="receiveMail">E-mail 수신</label></span>
