                        ...
                        <div class="formArea">
                            <fieldset>
                                ...
                                <div class="rrow">
                                    ...
                                    <div class="ffdata">
                                        <input type="text" id="recvName" name="recvName" class="ipTextLg" title="아이디">
                                    </div>
                                </div>
                                <div class="rrow">
                                    ...
                                    <div class="ffdata">
		                                ...
		                                <input type="text" id="cellNo02" name="cellNo02" value="" class="ipTextSm" title="휴대폰 가운데 번호" maxlength="4">
		                                <input type="text" id="cellNo03" name="cellNo03" value="" class="ipTextSm" title="휴대폰 마지막 번호" maxlength="4">
                                    </div>
                                </div>
                        <div class="rrow">
                            ...
                            <div class="ffdata">
                                ...
                                <div class="block">
                                	<input type="text" class="ipTextSm" id="txtOrderZipCode" name="txtOrderZipCode" readonly title="배송지 우편번호" value="" maxlength="6">
                                </div>
								<input type="text" class="ipTextXl" id="txtOrderAddr1" name="txtOrderAddr1" readonly title="기본 주소" value="" maxlength="120">
								<input type="text" class="ipTextXl" id="txtOrderAddr2" name="txtOrderAddr2" title="상세 주소" value="" maxlength="120">
                            </div>
                        </div>
                                <div class="chk_right">
                                <input type="checkbox" id="basicYn" name="basicYn" class="ipChekbox" value="Y">
                                <label for="basicYn">기본 배송지로 저장</label></div>
                            </fieldset>
                        </div>
                        <div class="btnArea">
                            <a href="javascript:;" class="btnTyBfaceLg" id="btnDeliverySave">저장</a>
                        </div>
                    </div>
         	</div>
         </form>
...
$(window.document).ready(function(){
	...
	$("#btnDeliverySave").click(function(){
		...
		$("form[name='myForm']").attr("action", "/newbalance/my/memberDeliveryInsertProc.action").attr("target", "_self").submit();
