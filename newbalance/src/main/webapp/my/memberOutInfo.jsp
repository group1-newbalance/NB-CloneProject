				...
				<div class="my_cont">
                    ...
                    <div class="con_my_boxdl">
                        <dl>
                            ...
                            <dt>소멸 안내</dt>
                            <dd>보유 마일리지?${myData.mileageAmount}점 (사용 가능 마일리지 ${myData.mileageAmount}점)</dd>
                            <dd>보유 쿠폰?${myData.couponCnt}개</dd>
                        </dl>
...
$(window.document).ready(function(){
	$("#btnMemberOut").click(function(){
		...
		if(confirm("회원 탈퇴 시 탈퇴일로부터 14일간 재가입이 불가하며,\n현재 보유하고 있는 쿠폰 및 마일리지는 모두 소멸됩니다.\n탈퇴하시겠습니까?")) {
			$("form[name='myForm']").attr("action", "/newbalance/my/memberOutProc.action").attr("target", "_self").submit();	
		}
	});
});	
...
function checkValidation()
{
	...
	{
		window.alert("회원탈퇴 안내와 마일리지 & 포인트 소멸 안내에 동의가 필요합니다.");
		agree.focus();
		return false;
	}
	/*
